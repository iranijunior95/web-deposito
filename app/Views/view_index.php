                            ...
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                    <li class="dropdown active">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-plus-square"></i> CADASTROS <span class="caret"></span></a>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-footer">
                                            ...
                                            <div class="pull-right">
                                                <a href="#" class="btn btn-default btn-flat"><i class="fa fa-sign-in"></i> SAIR</a>
                                            </div>
                                        </li>
                                    </ul>
